...
{	
	...
	*/
	...
	public static long mod = 10000000+7;
...
//****************************** Utilities ***********************//
public static long f(int i,int a[][] ,int vis[],int n,int m)throws Exception{
 			vis[i]=1;
			long ans =1;
			for(int i=1;i<=n;i++){
			  if(vis[i]==1)continue;
			  ans = (a[i] * f(i,a,vis,n,m))%mod;
			}
}

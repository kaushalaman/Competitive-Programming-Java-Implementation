		...
		int n = i(); int m = i();int k=i();
		 ...
		 for(int i=1;i<=k;i++){
		  ...
		  if(ans==0){
			...
			if((arr[x][y]==arr[x-1][y]&&arr[x][y]==arr[x-1][y-1]&&arr[x][y]==arr[x][y-1])||(arr[x][y]==arr[x-1][y]&&arr[x][y]==arr[x-1][y+1]&&arr[x][y]==arr[x][y+1])||(arr[x][y]==arr[x+1][y]&&arr[x][y]==arr[x+1][y-1]&&arr[x][y]==arr[x][y-1])||(arr[x][y]==arr[x+1][y]&&arr[x][y]==arr[x+1][y+1]&&arr[x][y]==arr[x][y+1]))
			ans = i;
		  }
		 }
		out.write(""+ans+"\n");

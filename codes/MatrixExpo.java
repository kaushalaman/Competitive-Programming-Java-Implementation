...
{	
	...
	*/
	...
	public static long f0=0,f1=0;
	public static void main(String[] args) throws java.lang.Exception{
		//let_me_start 
		 int tests = i();long n=0;
		 ...
		 for(int t=1;t<=tests;t++){
		   ...
		   long arr[][] = expo(Matrix,n); 
		   long  fn = ((arr[1][0]*f1)%mod + (arr[1][1]*f0)%mod)%mod;
		   /*out.write("printing  mat\n");
		   for(int a=0;a<2;a++){
						for(int b=0;b<2;b++){
						   out.write(""+arr[a][b]+" ");
						}
...
public static long[][] expo(long long [][]Matrix, long exp)throws Exception{
